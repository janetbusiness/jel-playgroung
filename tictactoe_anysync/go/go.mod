...
require (
	...
	github.com/anyproto/any-sync-node v0.0.0
...
replace github.com/anyproto/any-sync-node => ../research/any-sync-node

// replace directives for local development can be added as needed, e.g.:
